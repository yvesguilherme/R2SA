...
# 2. Instalar Java usando SDKMAN! na versão 21.0.4-oracle
echo "Instalando Java via SDKMAN! na versão 21.0.4-oracle..."
source "$HOME/.sdkman/bin/sdkman-init.sh"
...
# 5. Instalar Docker Desktop (precisa de root). Será usado o Docker Toolbox (sem root)
...
# 7. Baixar IntelliJ IDEA Community Edition
if [ ! -d "$BASE_DIR/idea" ]; then
    echo "Baixando IntelliJ IDEA Community Edition na versão 2024.3.3..."
    IDEA_URL="https://download.jetbrains.com/idea/ideaIC-2024.3.3.tar.gz"
...
echo "Se necessário, adicionar os binários ao PATH:"
